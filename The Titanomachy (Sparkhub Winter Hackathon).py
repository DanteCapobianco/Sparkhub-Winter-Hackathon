...
class Eris(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        #Load sprites + music
        stand_left = pygame.image.load('Eris_Goddess_of_Strife/Stand_+_Run/av_1-stand-left.png').convert_alpha()
        stand_right = pygame.image.load('Eris_Goddess_of_Strife/Stand_+_Run/av_1-stand-right.png').convert_alpha()
        run_left_1 = pygame.image.load('Eris_Goddess_of_Strife/Stand_+_Run/av_1-run_1-left.png').convert_alpha()
        run_left_2 = pygame.image.load('Eris_Goddess_of_Strife/Stand_+_Run/av_1-run_2-left.png').convert_alpha()
        run_left_3 = pygame.image.load('Eris_Goddess_of_Strife/Stand_+_Run/av_1-run_3-left.png').convert_alpha()
        run_right_1 = pygame.image.load('Eris_Goddess_of_Strife/Stand_+_Run/av_1-run_1-right.png').convert_alpha()
        run_right_2 = pygame.image.load('Eris_Goddess_of_Strife/Stand_+_Run/av_1-run_2-right.png').convert_alpha()
        run_right_3 = pygame.image.load('Eris_Goddess_of_Strife/Stand_+_Run/av_1-run_3-right.png').convert_alpha()
        jump_left_1 = pygame.image.load('Eris_Goddess_of_Strife/Jump/av_1-jump_1-left.png').convert_alpha()
        jump_left_2 = pygame.image.load('Eris_Goddess_of_Strife/Jump/av_1-jump_2-left.png').convert_alpha()
        jump_left_3 = pygame.image.load('Eris_Goddess_of_Strife/Jump/av_1-jump_3-left.png').convert_alpha()
        jump_left_4 = pygame.image.load('Eris_Goddess_of_Strife/Jump/av_1-jump_4-left.png').convert_alpha()
        jump_left_5 = pygame.image.load('Eris_Goddess_of_Strife/Jump/av_1-jump_5-left.png').convert_alpha()
        jump_right_1 = pygame.image.load('Eris_Goddess_of_Strife/Jump/av_1-jump_1-right.png').convert_alpha()
        jump_right_2 = pygame.image.load('Eris_Goddess_of_Strife/Jump/av_1-jump_2-right.png').convert_alpha()
        jump_right_3 = pygame.image.load('Eris_Goddess_of_Strife/Jump/av_1-jump_3-right.png').convert_alpha()
        jump_right_4 = pygame.image.load('Eris_Goddess_of_Strife/Jump/av_1-jump_4-right.png').convert_alpha()
        jump_right_5 = pygame.image.load('Eris_Goddess_of_Strife/Jump/av_1-jump_5-right.png').convert_alpha()
        respawn_right_1 = pygame.image.load('Eris_Goddess_of_Strife/Respawn/av_1-respawn_1-right.png').convert_alpha()
        respawn_right_2 = pygame.image.load('Eris_Goddess_of_Strife/Respawn/av_1-respawn_2-right.png').convert_alpha()
        respawn_right_3 = pygame.image.load('Eris_Goddess_of_Strife/Respawn/av_1-respawn_3-right.png').convert_alpha()
        respawn_left_1 = pygame.image.load('Eris_Goddess_of_Strife/Respawn/av_1-respawn_1-left.png').convert_alpha()
        respawn_left_2 = pygame.image.load('Eris_Goddess_of_Strife/Respawn/av_1-respawn_2-left.png').convert_alpha()
        respawn_left_3 = pygame.image.load('Eris_Goddess_of_Strife/Respawn/av_1-respawn_3-left.png').convert_alpha()
        melee_left_1 = pygame.image.load('Eris_Goddess_of_Strife/Melee/av_1-melee_1-left.png').convert_alpha()
        melee_left_2 = pygame.image.load('Eris_Goddess_of_Strife/Melee/av_1-melee_2-left.png').convert_alpha()
        melee_left_3 = pygame.image.load('Eris_Goddess_of_Strife/Melee/av_1-melee_4-left.png').convert_alpha()
        melee_left_4 = pygame.image.load('Eris_Goddess_of_Strife/Melee/av_1-melee_5-left.png').convert_alpha()
        melee_left_5 = pygame.image.load('Eris_Goddess_of_Strife/Melee/av_1-melee_6-left.png').convert_alpha()
        melee_left_6 = pygame.image.load('Eris_Goddess_of_Strife/Melee/av_1-melee_8-left.png').convert_alpha()
        melee_left_7 = pygame.image.load('Eris_Goddess_of_Strife/Melee/av_1-melee_10-left.png').convert_alpha()
        melee_right_1 = pygame.image.load('Eris_Goddess_of_Strife/Melee/av_1-melee_1-right.png').convert_alpha()
        melee_right_2 = pygame.image.load('Eris_Goddess_of_Strife/Melee/av_1-melee_2-right.png').convert_alpha()
        melee_right_3 = pygame.image.load('Eris_Goddess_of_Strife/Melee/av_1-melee_4-right.png').convert_alpha()
        melee_right_4 = pygame.image.load('Eris_Goddess_of_Strife/Melee/av_1-melee_5-right.png').convert_alpha()
        melee_right_5 = pygame.image.load('Eris_Goddess_of_Strife/Melee/av_1-melee_6-right.png').convert_alpha()
        melee_right_6 = pygame.image.load('Eris_Goddess_of_Strife/Melee/av_1-melee_8-right.png').convert_alpha()
        melee_right_7 = pygame.image.load('Eris_Goddess_of_Strife/Melee/av_1-melee_10-right.png').convert_alpha()
        range_left_1 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-range_1-left.png').convert_alpha()
        range_left_2 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-range_2-left.png').convert_alpha()
        range_left_3 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-range_3-left.png').convert_alpha()
        range_left_4 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-range_4-left.png').convert_alpha()
        range_right_1 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-range_1-right.png').convert_alpha()
        range_right_2 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-range_2-right.png').convert_alpha()
        range_right_3 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-range_3-right.png').convert_alpha()
        range_right_4 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-range_4-right.png').convert_alpha()
        bullet_1 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-bullet_1.png').convert_alpha()
        bullet_2 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-bullet_2.png').convert_alpha()
        bullet_3 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-bullet_3.png').convert_alpha()
        bullet_4 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-bullet_5.png').convert_alpha()
        bullet_5 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-bullet_6.png').convert_alpha()
        bullet_6 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-bullet_7.png').convert_alpha()
        bullet_7 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-bullet_8.png').convert_alpha()
        bullet_8 = pygame.image.load('Eris_Goddess_of_Strife/Long_Range/av_1-bullet_9.png').convert_alpha()
        explosion_1 = pygame.image.load('Eris_Goddess_of_Strife/Explosion_Animation/av_1-explosion_1.png').convert_alpha()
        explosion_2 = pygame.image.load('Eris_Goddess_of_Strife/Explosion_Animation/av_1-explosion_3.png').convert_alpha()
        explosion_3 = pygame.image.load('Eris_Goddess_of_Strife/Explosion_Animation/av_1-explosion_4.png').convert_alpha()
        explosion_4 = pygame.image.load('Eris_Goddess_of_Strife/Explosion_Animation/av_1-explosion_5.png').convert_alpha()
        explosion_5 = pygame.image.load('Eris_Goddess_of_Strife/Explosion_Animation/av_1-explosion_6.png').convert_alpha()
        explosion_6 = pygame.image.load('Eris_Goddess_of_Strife/Explosion_Animation/av_1-explosion_7.png').convert_alpha()
        heart_lives = pygame.image.load('Game_Environment/heart_lives.png').convert_alpha()
        self.jump_effect = pygame.mixer.Sound('Game_Environment/jump-sound.wav')
        self.sword_effect = pygame.mixer.Sound('Game_Environment/sword-sound.wav')
        self.sword_effect.set_volume(0.5)
        self.long_range_effect = pygame.mixer.Sound('Game_Environment/eris-long_range-sound.wav')
...
class Enyo(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        stand_left = pygame.image.load('Enyo_God_of_the_Underworld/Stand_+_Run/av_3-stand-left.png').convert_alpha()
        stand_right = pygame.image.load('Enyo_God_of_the_Underworld/Stand_+_Run/av_3-stand-right.png').convert_alpha()
        run_left_1 = pygame.image.load('Enyo_God_of_the_Underworld/Stand_+_Run/av_3-run_1-left.png').convert_alpha()
        run_left_2 = pygame.image.load('Enyo_God_of_the_Underworld/Stand_+_Run/av_3-run_2-left.png').convert_alpha()
        run_left_3 = pygame.image.load('Enyo_God_of_the_Underworld/Stand_+_Run/av_3-run_3-left.png').convert_alpha()
        run_right_1 = pygame.image.load('Enyo_God_of_the_Underworld/Stand_+_Run/av_3-run_1-right.png').convert_alpha()
        run_right_2 = pygame.image.load('Enyo_God_of_the_Underworld/Stand_+_Run/av_3-run_2-right.png').convert_alpha()
        run_right_3 = pygame.image.load('Enyo_God_of_the_Underworld/Stand_+_Run/av_3-run_3-right.png').convert_alpha()
        jump_left_1 = pygame.image.load('Enyo_God_of_the_Underworld/Jump/av_3-jump_2-left.png').convert_alpha()
        jump_left_2 = pygame.image.load('Enyo_God_of_the_Underworld/Jump/av_3-jump_1-left.png').convert_alpha()
        jump_left_3 = pygame.image.load('Enyo_God_of_the_Underworld/Jump/av_3-jump_3-left.png').convert_alpha()
        jump_left_4 = pygame.image.load('Enyo_God_of_the_Underworld/Jump/av_3-jump_4-left.png').convert_alpha()
        jump_right_1 = pygame.image.load('Enyo_God_of_the_Underworld/Jump/av_3-jump_2-right.png').convert_alpha()
        jump_right_2 = pygame.image.load('Enyo_God_of_the_Underworld/Jump/av_3-jump_1-right.png').convert_alpha()
        jump_right_3 = pygame.image.load('Enyo_God_of_the_Underworld/Jump/av_3-jump_3-right.png').convert_alpha()
        jump_right_4 = pygame.image.load('Enyo_God_of_the_Underworld/Jump/av_3-jump_4-right.png').convert_alpha()
        respawn_right_1 = pygame.image.load('Enyo_God_of_the_Underworld/Respawn/av_3-respawn_1-right.png').convert_alpha()
        respawn_right_2 = pygame.image.load('Enyo_God_of_the_Underworld/Respawn/av_3-respawn_2-right.png').convert_alpha()
        respawn_right_3 = pygame.image.load('Enyo_God_of_the_Underworld/Respawn/av_3-respawn_3-right.png').convert_alpha()
        respawn_left_1 = pygame.image.load('Enyo_God_of_the_Underworld/Respawn/av_3-respawn_1-left.png').convert_alpha()
        respawn_left_2 = pygame.image.load('Enyo_God_of_the_Underworld/Respawn/av_3-respawn_2-left.png').convert_alpha()
        respawn_left_3 = pygame.image.load('Enyo_God_of_the_Underworld/Respawn/av_3-respawn_3-left.png').convert_alpha()
        melee_left_1 = pygame.image.load('Enyo_God_of_the_Underworld/Melee/av_3-melee_1-left.png').convert_alpha()
        melee_left_2 = pygame.image.load('Enyo_God_of_the_Underworld/Melee/av_3-melee_2-left.png').convert_alpha()
        melee_left_3 = pygame.image.load('Enyo_God_of_the_Underworld/Melee/av_3-melee_3-left.png').convert_alpha()
        melee_left_4 = pygame.image.load('Enyo_God_of_the_Underworld/Melee/av_3-melee_4-left.png').convert_alpha()
        melee_left_5 = pygame.image.load('Enyo_God_of_the_Underworld/Melee/av_3-melee_5-left.png').convert_alpha()
        melee_right_1 = pygame.image.load('Enyo_God_of_the_Underworld/Melee/av_3-melee_1-right.png').convert_alpha()
        melee_right_2 = pygame.image.load('Enyo_God_of_the_Underworld/Melee/av_3-melee_2-right.png').convert_alpha()
        melee_right_3 = pygame.image.load('Enyo_God_of_the_Underworld/Melee/av_3-melee_3-right.png').convert_alpha()
        melee_right_4 = pygame.image.load('Enyo_God_of_the_Underworld/Melee/av_3-melee_4-right.png').convert_alpha()
        melee_right_5 = pygame.image.load('Enyo_God_of_the_Underworld/Melee/av_3-melee_5-right.png').convert_alpha()
        range_left_1 = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-range_1_7-left.png').convert_alpha()
        range_left_2 = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-range_2-left.png').convert_alpha()
        range_left_3 = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-range_3-left.png').convert_alpha()
        range_left_4 = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-range_4-left.png').convert_alpha()
        range_left_5 = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-range_5-left.png').convert_alpha()
        range_left_6 = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-range_6-left.png').convert_alpha()
        range_left_7 = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-range_1_7-left.png').convert_alpha()
        range_right_1 = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-range_1_7-right.png').convert_alpha()
        range_right_2 = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-range_2-right.png').convert_alpha()
        range_right_3 = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-range_3-right.png').convert_alpha()
        range_right_4 = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-range_4-right.png').convert_alpha()
        range_right_5 = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-range_5-right.png').convert_alpha()
        range_right_6 = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-range_6-right.png').convert_alpha()
        range_right_7 = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-range_1_7-right.png').convert_alpha()
        bullet_left = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-bullet-left.png').convert_alpha()
        bullet_right = pygame.image.load('Enyo_God_of_the_Underworld/Long_Range/av_3-bullet-right.png').convert_alpha()
        explosion_1 = pygame.image.load('Enyo_God_of_the_Underworld/Explosion_Animation/av_3-explosion_1.png').convert_alpha()
        explosion_2 = pygame.image.load('Enyo_God_of_the_Underworld/Explosion_Animation/av_3-explosion_2.png').convert_alpha()
        explosion_3 = pygame.image.load('Enyo_God_of_the_Underworld/Explosion_Animation/av_3-explosion_3.png').convert_alpha()
        explosion_4 = pygame.image.load('Enyo_God_of_the_Underworld/Explosion_Animation/av_3-explosion_4.png').convert_alpha()
        explosion_5 = pygame.image.load('Enyo_God_of_the_Underworld/Explosion_Animation/av_3-explosion_5.png').convert_alpha()
        explosion_6 = pygame.image.load('Enyo_God_of_the_Underworld/Explosion_Animation/av_3-explosion_6.png').convert_alpha()
        explosion_7 = pygame.image.load('Enyo_God_of_the_Underworld/Explosion_Animation/av_3-explosion_7.png').convert_alpha()
        explosion_8 = pygame.image.load('Enyo_God_of_the_Underworld/Explosion_Animation/av_3-explosion_8.png').convert_alpha()
        explosion_9 = pygame.image.load('Enyo_God_of_the_Underworld/Explosion_Animation/av_3-explosion_9.png').convert_alpha()
        heart_lives = pygame.image.load('Game_Environment/heart_lives.png').convert_alpha()
        self.jump_effect = pygame.mixer.Sound('Game_Environment/jump-sound.wav')
        self.melee_effect = pygame.mixer.Sound('Game_Environment/melee-sound.wav')
        self.melee_effect.set_volume(3)
        self.long_range_effect = pygame.mixer.Sound('Game_Environment/enyo-long_range-sound.wav')
...
countdown_1 = pygame.image.load('Game_Environment/countdown-1.png')
countdown_2 = pygame.image.load('Game_Environment/countdown-2.png')
countdown_3 = pygame.image.load('Game_Environment/countdown-3.png')
countdown_4 = pygame.image.load('Game_Environment/countdown-4.png')
countdown_5 = pygame.image.load('Game_Environment/countdown-5.png')
game_sign_image = pygame.image.load('Game_Environment/game_over.png')
main_menu_background = pygame.image.load('Game_Environment/main-menu-background.png')
instruction_menu_background = pygame.image.load('Game_Environment/instruction-menu-background.png')
choose_avatar_background = pygame.image.load('Game_Environment/choose-avatar-background.png')
game_background = pygame.image.load('Game_Environment/universe-background.png')
tie_background = pygame.image.load('Game_Environment/end-menu-tie_background.png')
eris_win_background = pygame.image.load('Game_Environment/end-menu-eris_background.png')
enyo_win_background = pygame.image.load('Game_Environment/end-menu-enyo_background.png')
platform_1_image = pygame.image.load('Game_Environment/platform_1.png')
platform_2_image = pygame.image.load('Game_Environment/platform_1.png')
...
background_music = pygame.mixer.Sound('Game_Environment/background-music.mp3')
background_music.set_volume(0.5)
background_music.play(loops = -1)
game_over_effect = pygame.mixer.Sound('Game_Environment/game-over-sound.wav')
